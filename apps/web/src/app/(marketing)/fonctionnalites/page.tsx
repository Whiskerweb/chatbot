        ...
        {features.map((feature, index) => {
          ...
          return (
            ...
            >
              {/* Image placeholder */}
              <div
                className={`rounded-2xl shadow-apple bg-card p-8 min-h-[360px] flex items-center justify-center ${
              ...
              <div className={isReversed ? "lg:order-1" : ""}>
                <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-muted/60 mb-4">
                  <Icon className="h-5 w-5 text-foreground" strokeWidth={1.5} />
                </div>
